...
async def cmd_post(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    _reply_anchor: Optional[int] = _anchor_msg if (_anchor_chat == ch.channel_chat_id and _anchor_msg) else None
...
async def _cmd_topic_m(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    try:
        ...
        # Save as topic anchor (always the base group/channel chat_id)
